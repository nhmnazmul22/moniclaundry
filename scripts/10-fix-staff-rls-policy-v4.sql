...
-- Catatan Penting:
-- Pastikan kolom 'id' di tabel 'staff' Anda adalah UUID yang sama dengan 'auth.uid()'
-- dari user yang login di Supabase Authentication. Jika tidak, RLS tidak akan berfungsi.
