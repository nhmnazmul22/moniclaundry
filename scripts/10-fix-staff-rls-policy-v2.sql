...
DROP POLICY IF EXISTS "Allow owner to update any staff" ON staff; -- Kebijakan sebelumnya
DROP POLICY IF EXISTS "Allow admin to update kurir" ON staff; -- Kebijakan sebelumnya
